...
public interface RoomService {
    ...
    List<TimeIntervalWeek> findTimeIntervals(UUID id);
    List<TimeIntervalWeek> findTimeIntervals(UUID id, UUID universityId);
    List<TimeIntervalWeek> findTimeIntervals(UUID id, String universityCode);
